...
execute if score difficulty game matches 0 in patchwreck:gothic run difficulty easy
execute if score difficulty game matches 0 in patchwreck:tomb run difficulty easy
execute if score difficulty game matches 0 in patchwreck:metropolis run difficulty easy
execute if score difficulty game matches 0 in patchwreck:grove run difficulty easy
execute if score difficulty game matches 0 in patchwreck:wasteland run difficulty easy

data merge entity d452d5a1-6012-4398-badb-cfe703efae74 {text:'[{"text":"Difficulty:\\n","color":"gray"},{"text":"Easy\\n\\n\\n\\n\\n\\n\\n\\n\\n","color":"green"}]'}
