...
#result
execute as @e[distance=..32,type=zombie,tag=dummy,nbt={HurtTime: 10s}] run tellraw @p [{"translate":"wtem.space","color":"red","italic":false},{"score":{"name":"dummydmg","objective":"temp"},"color":"dark_red","bold":true,"italic":false},{"translate":"tools.functions.dummy.dummy.2","italic":false},{"score":{"name":"dummydmg1","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.3"},{"score":{"name":"dummydps","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.2"},{"score":{"name":"dummydps1","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.5"},{"score":{"name":"vel","objective":"temp"},"color":"dark_aqua","bold":true},{"translate":"tools.functions.dummy.dummy.2","color":"aqua"},{"score":{"name":"vel1","objective":"temp"},"color":"dark_aqua","bold":true},{"translate":"tools.functions.dummy.dummy.7","color":"aqua"}]
execute as @a[distance=..6,nbt={HurtTime: 9s}] run tellraw @p [{"translate":"wtem.space","color":"red","italic":false},{"score":{"name":"phpdmg","objective":"temp"},"color":"dark_red","bold":true,"italic":false},{"translate":"tools.functions.dummy.dummy.2","italic":false},{"score":{"name":"phpdmg1","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.10"},{"score":{"name":"pcent","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.2"},{"score":{"name":"pcent1","objective":"temp"},"color":"dark_red","bold":true},{"translate":"tools.functions.dummy.dummy.12"},{"translate":"tools.functions.dummy.dummy.13","color":"gray"}]
