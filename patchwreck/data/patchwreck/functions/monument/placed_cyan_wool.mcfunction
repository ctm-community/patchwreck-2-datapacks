...
execute unless block 993 105 1029 minecraft:barrier run clear @s minecraft:cyan_wool{objective: 1b}
execute unless block 993 105 1029 minecraft:barrier as @a run playsound minecraft:ui.toast.challenge_complete player @s ~ ~ ~ 100 1.2
setblock 993 105 1029 minecraft:barrier
