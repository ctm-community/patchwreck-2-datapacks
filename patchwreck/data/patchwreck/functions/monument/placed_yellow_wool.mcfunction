...
execute unless block 998 105 1035 minecraft:barrier run clear @s minecraft:yellow_wool{objective: 1b}
execute unless block 998 105 1035 minecraft:barrier as @a run playsound minecraft:ui.toast.challenge_complete player @s ~ ~ ~ 100 1.2
setblock 998 105 1035 minecraft:barrier
