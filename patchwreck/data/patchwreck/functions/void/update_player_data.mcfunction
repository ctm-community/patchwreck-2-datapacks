...
execute positioned 0 100 0 as @s[distance=..250,nbt={Dimension: "minecraft:overworld"}] run function patchwreck:void/tether/setpoint {x: 0, y: 100, z: 0}
execute positioned 1000 100 1000 as @s[distance=..250,nbt={Dimension: "minecraft:overworld"}] run function patchwreck:void/tether/setpoint {x: 1000, y: 100, z: 1000}
