...
# 1. Player has fallen >32 blocks below their tether with >4 blocks of air beneath them
scoreboard players set $check_void_depth patchwreck.variables 4
execute if score @s patchwreck.position.dy matches ..-32 if function patchwreck:void/depth/check run tag @s add patchwreck.void_return
