...
execute as @e[type=!player,distance=..7] if entity @e[type=marker,tag=enderayo.shieldability,distance=..7] run damage @s 20 dragon_breath by @p[scores={enderayo.shieldability=1..}]
...
scoreboard players set .cd enderayo.shieldability 1200