...
execute if score $light_blue enderayo.hyperdrift matches 0 run bossbar set enderayo:hyperdrift name [{"text":"Hyperdrift - Offense Mode", "color":"light_purple"}]
...
execute if score $magenta enderayo.hyperdrift matches 0 run bossbar set enderayo:hyperdrift name [{"text":"Hyperdrift - Defense Mode", "color":"aqua"}]
