...
data merge entity @s {Silent: 1b, DeathLootTable: "manoloesmanolo:empty", CanPickUpLoot: 0b, Health: 6f, IsBaby: 1b, CustomName: '{"translate":"manoloesmanolo.functions.bloodbeet.convert_beet.1"}', HandItems: [{}, {}], ArmorDropChances: [0.085f, 0.085f, 0.085f, 2.000f], active_effects: [{id: "minecraft:strength", amplifier: 0b, duration: -1}, {id: "minecraft:invisibility", amplifier: 0b, duration: -1, show_particles: 0b}], Attributes: [{Name: "generic.max_health", Base: 6}, {Name: "generic.knockback_resistance", Base: 1}, {Name: "generic.movement_speed", Base: 0.1d}]}
