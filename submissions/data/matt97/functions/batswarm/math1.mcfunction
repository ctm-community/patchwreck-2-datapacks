...
data modify storage matt97:batswarm.bat xPush set value {}
data modify storage matt97:batswarm.bat yPush set value {}
data modify storage matt97:batswarm.bat zPush set value {}

execute store result storage matt97:batswarm.bat xPush double 0.05 run scoreboard players get m97_dummyPlayer m97_Motion_x
execute store result storage matt97:batswarm.bat yPush double 0.05 run scoreboard players get m97_dummyPlayer m97_Motion_y
execute store result storage matt97:batswarm.bat zPush double 0.05 run scoreboard players get m97_dummyPlayer m97_Motion_z
