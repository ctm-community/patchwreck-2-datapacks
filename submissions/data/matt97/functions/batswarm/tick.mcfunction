...
function matt97:batswarm/swarm_storage

execute positioned ~-8 ~-8 ~-8 as @e[dx=15,dy=15,dz=15,type=bat,tag=m97_swarm] anchored eyes at @s run function matt97:batswarm/bat
