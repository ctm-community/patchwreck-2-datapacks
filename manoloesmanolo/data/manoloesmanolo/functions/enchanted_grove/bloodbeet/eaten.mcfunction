#> manoloesmanolo:enchanted_grove/bloodbeet/eaten
...
execute if score @s bloodbeet.item_slot matches 0 run data modify storage manoloesmanolo:enchanted_grove bloodbeet.item_slot set value "weapon.mainhand"
execute if score @s bloodbeet.item_slot matches -106 run data modify storage manoloesmanolo:enchanted_grove bloodbeet.item_slot set value "weapon.offhand"
...
execute store result storage manoloesmanolo:enchanted_grove bloodbeet.count byte 1 run scoreboard players get @s bloodbeet.stack_count

# If stack count is 0, replace beet with leftovers, otherwise decrease stack by 1
execute if score @s bloodbeet.stack_count matches ..0 run function manoloesmanolo:enchanted_grove/bloodbeet/replace_leftovers with storage manoloesmanolo:enchanted_grove bloodbeet
execute if score @s bloodbeet.stack_count matches 1.. run function manoloesmanolo:enchanted_grove/bloodbeet/replace_beet with storage manoloesmanolo:enchanted_grove bloodbeet

# Simulate item consumption and give effects
playsound minecraft:entity.player.burp player @a ~ ~ ~ 1 1 1
effect give @s minecraft:saturation 4 0 true
